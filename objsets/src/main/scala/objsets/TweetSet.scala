...
abstract class TweetSet {
  ...
  /**
    ...
    *
    * We can implement this here, since the implementation is the same for
    * an empty and a non-empty set.
    */
  ...
  /**
    ...
    * an empty and a non-empty set.
    */
  def union(that: TweetSet): TweetSet = if (isEmpty) that else filterAcc(tweet => true, that)
...
class Empty extends TweetSet {
  ...
  def mostRetweeted = throw new java.util.NoSuchElementException("no elements to be retweeted!")
...
class NonEmpty(elem: Tweet, left: TweetSet, right: TweetSet) extends TweetSet {
  ...
  def filterAcc(p: Tweet => Boolean, acc: TweetSet): TweetSet = {
    // if our item satisfies p, add it to the accumulator and recursively get all of our entries.
